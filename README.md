...
### Bundled version
 ...
 2. Download the latest release of TiddlyServer from https://github.com/Arlen22/TiddlyServer/releases unzip the folder contained in the zip file to wherever you want it. __Put the NodeJS binary (node.exe) in this folder if you want it to be portable.__
