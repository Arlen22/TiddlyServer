/*\
title: $:/plugins/arlen22/WebSocketServer/WS/WebSocket.js
...
const Ultron = require('$:/plugins/arlen22/WebSocketServer/Ultron/Ultron.js');
const https = require('https');
const http = require('http');
const url = require('url');

const PerMessageDeflate = require('$:/plugins/arlen22/WebSocketServer/WS/PerMessageDeflate');
const EventTarget = require('$:/plugins/arlen22/WebSocketServer/WS/EventTarget');
const Extensions = require('$:/plugins/arlen22/WebSocketServer/WS/Extensions');
const constants = require('$:/plugins/arlen22/WebSocketServer/WS/Constants');
const Receiver = require('$:/plugins/arlen22/WebSocketServer/WS/Receiver');
const Sender = require('$:/plugins/arlen22/WebSocketServer/WS/Sender');
